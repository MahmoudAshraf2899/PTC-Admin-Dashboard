      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 min-h-screen">
        <div className="hidden h-screen md:h-auto xl:block">
          <div className="py-17.5 px-26 text-center">
            ...
            <p className="2xl:px-20">BEST SOLUTION FOR YOUR BUSINESS</p>
        ...
        <div className="w-full border-stroke dark:border-strokedark  xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            <h2 className="mb-9 text-2xl xsm:text-center font-bold text-black dark:text-white sm:text-title-xl2">
