...
export const Developments = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    API.get(`${END_POINTS.GET_DEVELOPMENT}/1`).then((res) => {
      if (res.status == 200) {
  ...
  return (
    <>
      <Breadcrumb pageName="Developments Page" />
              ...
              {({
                ...
                <>
                  <form onSubmit={handleSubmit}>
                    <div className="p-6.5">
                      {/* <!--   Title --> */}
                      <div className="lg:mb-4.5 flex lg:items-center xs:items-start flex-col lg:gap-6 md:gap-4 sm:gap-4 xs:gap-2 gap-6 xl:flex-row">
