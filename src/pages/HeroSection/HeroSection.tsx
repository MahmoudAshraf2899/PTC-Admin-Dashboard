...
const validationSchema = Yup.object().shape({
  mainTitle: Yup.string()
    ...
    .min(10, 'Main Title must be at least 10 characters')
    .max(48, 'Main Title must be at most 48 characters'),
  subTitle: Yup.string()
    .required('Sub Title is required')
    .min(10, 'Sub Title  must be at least 10 characters')
    .max(22, 'Sub Title  must be at most 22 characters'),
  subTitleDescription: Yup.string()
    .required('Sub Title Description is required')
    .min(10, 'Sub Title Description must be at least 10 characters')
    .max(129, 'Sub Title Description must be at most 129 characters'),
